...
int main(){
	...
	insertar(p, crearNodo(crearPersona("Sol","Rodriguez", 13270323, 45, "Femenino")));
	insertar(p, crearNodo(crearPersona("Uldren","Gedde", 11086106, 51, "Masculino")));
	insertar(p, crearNodo(crearPersona("Juana","Rodriguez", 38470667, 72, "Femenino")));
	insertar(p, crearNodo(crearPersona("Gabriela","Gedde", 30026952, 18, "Femenino")));
	insertar(p, crearNodo(crearPersona("Iliana","Gedde", 29352779, 21, "Femenino")));
	insertar(p, crearNodo(crearPersona("Gian","Franco", 29691969, 82, "Masculino")));
	insertar(p, crearNodo(crearPersona("Erika","Tourt", 30333753, 22, "Femenino")));
	imprimir(p);
	return 0;
}
